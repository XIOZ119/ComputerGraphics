...
GLint nNumPoints = 4; // 4X4 곡선을 위한 제어점 

//X과 Y축을 따라 -6~6까지 4개의 단위로 Mesh 확장. 평면은 z축에 존재 
...
void MyMotion(int x, int y)
{
	...
	if (bMousing)
	{
		g_fSpinX -= (ptCurrentMousePosit.x);
		g_fSpinY -= (ptCurrentMousePosit.y);
	}
